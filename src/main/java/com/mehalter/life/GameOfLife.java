...
public class GameOfLife implements Runnable {
    ...
    public GameOfLife() {
        gameState = new GameState(new Timer(100, (e) -> nextStep()));
    ...
    public void run() {
        ...
        gameState.getGridPanel().addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                gameState.setCurrentY((int) (e.getX() / ((double) gameState.getGridPanel().getWidth() / gameState.getxSize())));
                gameState.setCurrentX((int) (e.getY() / ((double) gameState.getGridPanel().getHeight() / gameState.getxSize())));
